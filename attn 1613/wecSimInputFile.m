...
simu.simMechanicsFile = 'raft.slx';      % Specify Simulink Model File
...
% wave.direction=45*pi/180;
% waves.period = double(2*pi/ww);% 
...
% waves = waveClass('irregular');           % Initialize Wave Class and Specify Type
% waves.height = 5;                       % Significant Wave Height [m]
% waves.period = 8;                         % Peak Period [s]
...
%% Body Data
% Float
body(1) = bodyClass('hydroData/raftL=40D=10.h5');      
    % Create the body(1) Variable, Set Location of Hydrodynamic Data File 
    % and Body Number Within this File.   
body(1).geometryFile = 'geometry/left1_raftL=40_D=10.stl';    % Location of Geomtry File
body(1).mass = 'equilibrium';                   
    % Body Mass. The 'equilibrium' Option Sets it to the Displaced Water 
    % Weight.
body(1).inertia = [666666.666 5666666.667 566666.667];  % Moment of Inertia [kg*m^2]     
body(1).centerGravity=[-25,0,0];
% Spar/Plate
body(2) = bodyClass('hydroData/raftL=40D=10.h5'); 
body(2).geometryFile = 'geometry/right1_raftL=40_D=10.stl'; 
body(2).mass = 'equilibrium';                   
body(2).inertia =  [666666.666 5666666.667 566666.667];
body(2).centerGravity=[25,0,0];
...
pto(1).initial.displacement=[0 0 0];
